...
export default function BoatsManagement({ darkMode }) {
  ...
  // ✅ CSV export (kept from Vihangi branch) — exports CURRENT filtered list
  ...
  // ✅ PDF export (from test1) — exports CURRENT filtered list with equipment column too
