...
import { exportTablePDF } from "../../utils/pdfExporter"; // ✅ use shared exporter
...
export default function EquipmentManagement({ darkMode }) {
  ...
  const handleExportPDF = async () => {
    ...
    await exportTablePDF({
      ...
      meta: { "Total Equipment": equipment.length },
      columns,
      rows: equipment,
    ...
    >
      <div className="flex flex-wrap justify-between items-center mb-6 gap-2">
        ...
        <div className="flex gap-2">
          <button
            ...
            title="Export all equipment as PDF"
          >
      ...
      {loading ? (
        ...
        >
          <Package
            size={48}
            className={`mx-auto mb-4 ${darkMode ? "text-slate-400" : "text-gray-400"}`}
          />
          <h2
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center space-x-3">
                      <Link
                        ...
                        className={
                          darkMode
                            ? "p-1 text-slate-300 hover:text-cyan-400"
                            : "p-1 text-gray-600 hover:text-blue-800"
                        }
                        title="View Details"
                      >
                        <Package size={18} />
                      ...
                      <button
                        onClick={() =>
                          navigate(`/admin/equipment/editEquipment/${item.equipmentID}`)
                        }
                        className={
                          darkMode
                            ? "p-1 text-cyan-400 hover:text-cyan-200"
