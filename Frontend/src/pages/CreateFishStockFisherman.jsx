...
export default function CreateFishStockFisherman() {
  ...
  // Set current date as default for catch date & load products
  useEffect(() => {
    ...
    <div className="w-full min-h-screen p-4 bg-gradient-to-br from-sky-50 via-cyan-50 to-blue-50">
      <div className="max-w-md mx-auto bg-white rounded-2xl shadow-lg p-6">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Add New Fish Stock</h1>
        </div>
